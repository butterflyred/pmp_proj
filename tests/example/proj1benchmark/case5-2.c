...
int main()
{
    ...
    write_csr(pmpcfg0  ,0b10011001100110011001100110011001);
    write_csr(pmpcfg1  ,0b10011001100110011001100110011001);
    write_csr(pmpcfg2  ,0b10011001100110011001100110011001);
    write_csr(pmpcfg3  ,0b10011111100110011001100110011001); //  1001111 ,  10011001
    ...
    *(int*) 0x10000003 = 42; // io_addr = 000100000011

    if (*(int*) 0x10000003 == 42)
