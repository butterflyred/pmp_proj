...
int main()
{
    ...
    write_csr(pmpcfg0  ,0b10000001100000011000000110000001); // lock=1 & OFF & no write 10000001
    write_csr(pmpcfg1  ,0b10000001100000011000000110000001);
    write_csr(pmpcfg2  ,0b10000001100000011000000110000001);
    write_csr(pmpcfg3  ,0b10000001100000011000000110000001);
