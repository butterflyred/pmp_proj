...
int main()
{
    ...
    write_csr(pmpcfg0  ,0b10011101100111011001110110011101); // lock=1 & napot & no write 10011101
    write_csr(pmpcfg1  ,0b10011101100111011001110110011101);
    write_csr(pmpcfg2  ,0b10011101100111011001110110011101);
    write_csr(pmpcfg3  ,0b10011101100111011001110110011101);
    ...
    *(int*) 0x10000001 = 42; // io_addr = 000100000001
