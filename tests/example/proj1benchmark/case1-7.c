...
int main()
{
    ...
    write_csr(pmpcfg0  ,0b10011110100111101001111010011110); // lock=1 & napot & write 10011110
    write_csr(pmpcfg1  ,0b10011110100111101001111010011110);
    write_csr(pmpcfg2  ,0b10011110100111101001111010011110);
    write_csr(pmpcfg3  ,0b10011110100111101001111010011110);
